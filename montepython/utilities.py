...
print 'I will keep cosmology from ', mat1_name,
print ' and nuisance from ', mat2_name
print 'If you want the contrary, change the order of calling'
...
print 'I will then include the matrix elements of the first matrix up to ',
print list1[N-1]
...
for elem in list2:
    ...
    print i+1, elem
print
print 'I will append the ending parameters of ', mat2_name,
print ' starting from the Mth one'
print '\n'
M = int(raw_input('Specify M: '))
print 'I will then include the matrix elements of the second matrix from ',
print list2[M-1]
